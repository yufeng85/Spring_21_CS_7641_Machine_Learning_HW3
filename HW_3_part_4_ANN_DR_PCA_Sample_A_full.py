...
x_train_transform_PCA = pca.transform(x_train_origin)
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('Sample_A_part_4_PCA_full_ANN_sample_A_Learning_curves_for_ANN_Default_setting.png',dpi=600)
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Sample_A_part_4_PCA_full_ANN_sample_A_Validation_Curve_Max_iteration.png',dpi=600)
plt.show()
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Sample_A_part_4_PCA_full_ANN_sample_A_Validation_Curve_hidden_layer_sizes_logistic.png',dpi=600)
plt.show()
...
plt.grid(True)
plt.xscale('log')
plt.savefig('Sample_A_part_4_PCA_full_ANN_sample_A_Validation_Curve_alpha.png',dpi=600)
plt.show()
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Sample_A_part_4_PCA_full_ANN_sample_A_Validation_Curve_momentum.png',dpi=600)
plt.show()
...
#plt.legend(loc="best")
plt.grid(True)
plt.savefig('Sample_A_part_4_PCA_ANN_sample_A_momentum_VS_Iteration.png',dpi=600)
plt.show()
...
train_sizes, train_scores, validation_scores = learning_curve(
estimator = MLPClassifier(solver='sgd',activation = 'logistic',max_iter = 2000,alpha = 1e-4,hidden_layer_sizes = (20),random_state = 0),
X = x_train,
y = y_train.values.ravel(), train_sizes = train_sizes, cv = 5,
scoring = 'accuracy',
shuffle = True,
...
plt.xlabel('Training set size')
#plt.xlabel('Training set size', fontsize = 14)
plt.title('Learning curves for ANN with PCA', y = 1.03)
plt.legend()
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('Sample_A_part_4_PCA_full_ANN_sample_A_Learning_curves_for_ANN_after_hyper_parameter_tunning.png',dpi=600)
