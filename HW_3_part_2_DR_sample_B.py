...
#PCA
#==============================================================================
pca = PCA(n_components=x_train.shape[1],random_state=0)
pca.fit(x_train)
#X_r_PCA = pca.fit(x_train).transform(x_train)

n_component_range = range(1,x_train.shape[1]+1)
fig = plt.figure()
...
plt.savefig('Sample_B_Part_2_Variance VS Components for PCA.png',dpi=600)
#==============================================================================
MSE_PCA = []
...
plt.figure()
plt.plot(range(1,x_train.shape[1]+1), MSE_PCA)
plt.xticks(range(1,x_train.shape[1]+1))
plt.xlabel("Number of Components")
plt.ylabel("Mean Square Error (MSE)")
plt.title('MSE VS Number of Components for PCA')
plt.grid(True)
plt.savefig('Sample_B_Part_2_MSE VS Number of Components for PCA.png',dpi=600)
...
n_component_range = range(1,x_train.shape[1]+1)
fig = plt.figure()
plt.plot(n_component_range, pca.explained_variance_)
plt.xticks(range(1,x_train.shape[1]+1))
plt.xlabel("Number of Components")
plt.ylabel("Mean Square Error (MSE)")
plt.title('MSE VS Number of Components for PCA')
...
for k in range(1,x_train.shape[1]+1):
    ...
    ica = FastICA(n_components=k,max_iter=2000, random_state=100)
    ica.fit(x_train)
...
plt.figure()
plt.plot(range(1,x_train.shape[1]+1), kurts)
plt.xticks(range(1,x_train.shape[1]+1))
plt.xlabel("Number of Components")
plt.ylabel("Avrage Kurtosis")
plt.title('Avrage Kurtosis VS Number of Components for ICA')
plt.grid(True)
plt.savefig('Sample_B_Part_2_Avrage Kurtosis VS Number of Components for ICA 2.png',dpi=600)  
...
plt.figure()
plt.plot(range(1,x_train.shape[1]+1),MSE_mean_ICA, label = 'MSE for FA', color="C0", lw=2)
plt.fill_between(range(1,x_train.shape[1]+1), MSE_mean_ICA - MSE_std_ICA, MSE_mean_ICA + MSE_std_ICA, alpha=0.2,color="C0", lw=2)
...
plt.xticks(range(1,x_train.shape[1]+1))
plt.tight_layout()
plt.savefig('Sample_B_Part_2_MSE VS Number of Components for ICA.png',dpi=600)
...
plt.figure()
plt.plot(range(1,x_train.shape[1]+1),MSE_mean_RP, label = 'MSE for RP', color="C0", lw=2)
plt.fill_between(range(1,x_train.shape[1]+1), MSE_mean_RP - MSE_std_RP, MSE_mean_RP + MSE_std_RP, alpha=0.2,color="C0", lw=2)
plt.ylabel('Mean Square Error (MSE)', fontsize = 14)
plt.xlabel('Number of Components', fontsize = 14)
...
plt.xticks(range(1,x_train.shape[1]+1))
plt.tight_layout()
plt.savefig('Sample_B_Part_2_MSE VS Number of Components for Random Projection.png',dpi=600)
...
plt.figure()
plt.plot(range(1,x_train.shape[1]+1),MSE_mean_FA, label = 'MSE for FA', color="C0", lw=2)
plt.fill_between(range(1,x_train.shape[1]+1), MSE_mean_FA - MSE_std_FA, MSE_mean_FA + MSE_std_FA, alpha=0.2,color="C0", lw=2)
plt.ylabel('Mean Square Error (MSE)', fontsize = 14)
plt.xlabel('Number of Components', fontsize = 14)
...
plt.xticks(range(1,x_train.shape[1]+1))
plt.tight_layout()
plt.savefig('Sample_B_Part_2_MSE VS Number of Components for Factor Analysis.png',dpi=600)

#==============================================================================
#Reconstructuion error
#==============================================================================
plt.figure()
plt.plot(range(1,x_train.shape[1]+1),MSE_PCA, label = 'MSE for PCA', color="C0", lw=2)
#plt.plot(range(1,x_train.shape[1]+1),MSE_mean_ICA, label = 'MSE for ICA', color="C1", lw=2)
#plt.fill_between(range(1,x_train.shape[1]+1), MSE_mean_ICA - MSE_std_ICA, MSE_mean_ICA + MSE_std_ICA, alpha=0.2,color="C1", lw=2)
plt.plot(range(1,x_train.shape[1]+1),MSE_mean_RP, label = 'MSE for RP', color="C2", lw=2)
plt.fill_between(range(1,x_train.shape[1]+1), MSE_mean_RP - MSE_std_RP, MSE_mean_RP + MSE_std_RP, alpha=0.2,color="C2", lw=2)
plt.plot(range(1,x_train.shape[1]+1),MSE_mean_FA, label = 'MSE for FA', color="C3", lw=2)
plt.fill_between(range(1,x_train.shape[1]+1), MSE_mean_FA - MSE_std_FA, MSE_mean_FA + MSE_std_FA, alpha=0.2,color="C3", lw=2)
plt.ylabel('Mean Square Error (MSE)', fontsize = 14)
plt.xlabel('Number of Components', fontsize = 14)
...
plt.xticks(range(1,x_train.shape[1]+1))
plt.tight_layout()
plt.savefig('Sample_B_Part_2_MSE VS Number of Components for Dimensionality Reduction 2.png',dpi=600)
...
GMM = GaussianMixture(6, covariance_type='diag', random_state=0)
