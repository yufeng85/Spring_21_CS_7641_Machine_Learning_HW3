...
ica.fit(x_train_origin)
x_train_transform_ICA = ica.transform(x_train_origin)
...
x_train = ica.transform(x_train_origin)
x_test = ica.transform(x_test_origin)
...
plt.title('Learning curves for ANN with ICA', y = 1.03)
plt.legend()
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('Sample_A_part_4_ICA_full_ANN_sample_A_Learning_curves_for_ANN_Default_setting.png',dpi=600)
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Sample_A_part_4_ICA_full_ANN_sample_A_Validation_Curve_Max_iteration.png',dpi=600)
plt.show()
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Sample_A_part_4_ICA_full_ANN_sample_A_Validation_Curve_hidden_layer_sizes_logistic.png',dpi=600)
plt.show()
...
plt.grid(True)
plt.xscale('log')
plt.savefig('Sample_A_part_4_ICA_full_ANN_sample_A_Validation_Curve_alpha.png',dpi=600)
plt.show()
...
plt.legend(loc="best")
plt.grid(True)
plt.savefig('Sample_A_part_4_ICA_full_ANN_sample_A_Validation_Curve_momentum.png',dpi=600)
plt.show()
...
#plt.legend(loc="best")
plt.grid(True)
plt.savefig('Sample_A_part_4_ICA_ANN_sample_A_momentum_VS_Iteration.png',dpi=600)
plt.show()
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('Sample_A_part_4_ICA_full_ANN_sample_A_Learning_curves_for_ANN_after_hyper_parameter_tunning.png',dpi=600)
