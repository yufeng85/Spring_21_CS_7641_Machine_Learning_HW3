...
n_sse = 10
n_sil = 8
str_see = 'Sample_B_Part_3_kmean_PCA_Sum of Squared Error (SSE) VS Number of Clusters.png'
str_sil = 'Sample_B_Part_3_kmean_PCA_Silhouette Coefficient VS Number of Clusters.png'
...
str_pair_plot = 'Sample_B_Part_3_kmean_PCA_Pair Plot for k-means.png'
kmean_pair_plot(x_train_PCA,3,str_pair_plot)

str_TSNE = 'Sample_B_Part_3_kmean_PCA_TSNE of k-means Clustering of Sample B.png'
title_TSNE = 'TSNE of k-means Clustering after PCA'
kmean_TSNE(x_train_PCA,3,str_TSNE,title_TSNE)

str_2D = 'Sample_B_Part_3_kmean_PCA_2D k-means Clustering of Sample B.png'
title_2D = 'k-means Clustering after PCA'
kmean_2D(x_train_PCA,3,str_2D,title_2D)

#==============================================================================
#ICA
#==============================================================================
ica = FastICA(n_components=2,max_iter=2000, random_state=100)
ica.fit(x_train)
x_train_ICA = ica.transform(x_train)

n_sse = 10
n_sil = 8
str_see = 'Sample_B_Part_3_kmean_ICA_Sum of Squared Error (SSE) VS Number of Clusters.png'
str_sil = 'Sample_B_Part_3_kmean_ICA_Silhouette Coefficient VS Number of Clusters.png'
...
str_pair_plot = 'Sample_B_Part_3_kmean_ICA_Pair Plot for k-means.png'
kmean_pair_plot(x_train_ICA,3,str_pair_plot)

str_TSNE = 'Sample_B_Part_3_kmean_ICA_TSNE of k-means Clustering of Sample B.png'
title_TSNE = 'TSNE of k-means Clustering after ICA'
kmean_TSNE(x_train_ICA,3,str_TSNE,title_TSNE)

str_2D = 'Sample_B_Part_3_kmean_ICA_2D k-means Clustering of Sample B.png'
...
n_sse = 10
n_sil = 8
str_see = 'Sample_B_Part_3_kmean_RP_Sum of Squared Error (SSE) VS Number of Clusters.png'
str_sil = 'Sample_B_Part_3_kmean_RP_Silhouette Coefficient VS Number of Clusters.png'
...
str_pair_plot = 'Sample_B_Part_3_kmean_RP_Pair Plot for k-means.png'
kmean_pair_plot(x_train_RP,3,str_pair_plot)

str_TSNE = 'Sample_B_Part_3_kmean_RP_TSNE of k-means Clustering of Sample B.png'
...
n_sse = 10
n_sil = 8
str_see = 'Sample_B_Part_3_kmean_FA_Sum of Squared Error (SSE) VS Number of Clusters.png'
str_sil = 'Sample_B_Part_3_kmean_FA_Silhouette Coefficient VS Number of Clusters.png'
...
str_pair_plot = 'Sample_B_Part_3_kmean_FA_Pair Plot for k-means.png'
kmean_pair_plot(x_train_FA,3,str_pair_plot)

str_TSNE = 'Sample_B_Part_3_kmean_FA_TSNE of k-means Clustering of Sample B.png'
title_TSNE = 'TSNE of k-means Clustering after FA'
kmean_TSNE(x_train_FA,3,str_TSNE,title_TSNE)

str_2D = 'Sample_B_Part_3_kmean_FA_2D k-means Clustering of Sample B.png'
...
str_bic = 'Sample_B_Part_3_EM_PCA_BIC Score for Various Model.png'
...
str_pair_plot = 'Sample_B_Part_3_EM_PCA_Pair Plot for EM.png'
EM_pair_plot(x_train_PCA,n_cluster,c_type,str_pair_plot)

str_TSNE = 'Sample_B_Part_3_EM_PCA_TSNE of EM Clustering of Sample B.png'
title_TSNE = 'TSNE of EM Clustering after PCA'
EM_TSNE(x_train_PCA,n_cluster,c_type,str_TSNE,title_TSNE)

str_2d = 'Sample_B_Part_3_EM_PCA_EM Clustering of Sample B.png'
...
str_bic = 'Sample_B_Part_3_EM_ICA_BIC Score for Various Model.png'
...
str_pair_plot = 'Sample_B_Part_3_EM_ICA_Pair Plot for EM.png'
EM_pair_plot(x_train_ICA,n_cluster,c_type,str_pair_plot)

str_TSNE = 'Sample_B_Part_3_EM_ICA_TSNE of EM Clustering of Sample B.png'
title_TSNE = 'TSNE of EM Clustering after ICA'
EM_TSNE(x_train_ICA,n_cluster,c_type,str_TSNE,title_TSNE)

str_2d = 'Sample_B_Part_3_EM_ICA_EM Clustering of Sample B.png'
...
str_bic = 'Sample_B_Part_3_EM_RP_BIC Score for Various Model.png'
...
str_pair_plot = 'Sample_B_Part_3_EM_RP_Pair Plot for EM.png'
EM_pair_plot(x_train_RP,n_cluster,c_type,str_pair_plot)

str_TSNE = 'Sample_B_Part_3_EM_RP_TSNE of EM Clustering of Sample B.png'
...
str_bic = 'Sample_B_Part_3_EM_FA_BIC Score for Various Model.png'
...
str_pair_plot = 'Sample_B_Part_3_EM_FA_Pair Plot for EM.png'
EM_pair_plot(x_train_FA,n_cluster,c_type,str_pair_plot)

str_TSNE = 'Sample_B_Part_3_EM_FA_TSNE of EM Clustering of Sample B.png'
title_TSNE = 'TSNE of EM Clustering after FA'
EM_TSNE(x_train_FA,n_cluster,c_type,str_TSNE,title_TSNE)

str_2d = 'Sample_B_Part_3_EM_FA_EM Clustering of Sample B.png'
